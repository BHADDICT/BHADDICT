...
<header>
  ...
  <span id="productQty" style="min-width: 24px; text-align: center;">1</span>
  <button id="increaseQty" style="padding: 6px 10px; font-size: 16px;">+</button>
</div>
...
<div class="accordion">
  <button class="accordion-toggle">Size Chart</button>
...
// Product quantity controls (outside cart)
...
document.querySelector(".add-to-cart").addEventListener("click", () => {
  ...
  if (existingItem) {
    ...
    cart.push({ name: productName, size, price, qty, image });
  }
...
function updateCartUI() {
  ...
  checkoutBtn.innerText = `CHECK OUT $${(total + 2).toFixed(2)}`; // $2 delivery fee
}
